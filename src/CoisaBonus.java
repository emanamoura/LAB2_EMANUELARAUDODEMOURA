...
public class CoisaBonus {
	...
	public static void main(String[] args) {
	   ...
	   private static void disciplina() {
	       ...
	       System.out.println("----");
	       int[] pesos = {2 , 4};
	       Disciplina redes = new Disciplina("Redes", 2, pesos);
	       redes.cadastraHoras(6);
	       redes.cadastraNota(1, 6.0);
	       redes.cadastraNota(2, 10.0);
	       System.out.println(redes.aprovado());
	       System.out.println(redes.toString());
	   }
